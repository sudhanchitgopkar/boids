...
class predBoid {
  ...
  PVector sep (ArrayList <predBoid> boids) {
    float desiredSep = 25.0f;
    PVector steer = new PVector (0,0,0);
    int count = 0;
    
    for (predBoid other: boids) {
  ...
  PVector ali (ArrayList <predBoid> boids) {
  ...
  PVector coh (ArrayList <predBoid> boids) {
    float neighborDist = 50;
    PVector sum = new PVector (0,0);
    int count = 0;
  ...
  PVector predate(ArrayList <preyBoid> prey) {
      float predDist = 50;
      PVector sum = new PVector (0,0);
      int count = 0;
